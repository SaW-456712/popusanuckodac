...
if not BOT_TOKEN:
    logging.error("КРИТИЧЕСКАЯ ОШИБКА: BOT_TOKEN не найден в окружении!")
    exit()

bot = Bot(token=BOT_TOKEN)
dp = Dispatcher()

# Папка внутри контейнера, куда будут временно падать треки
...
async def main():
    logging.info("Бот запущен в Docker-контейнере...")
